...
namespace TagsCloudVisualization.Tests
{
    ...
    internal class WordExtractorShould
    {
        ...
        {
            var result = WordExtractor.ExtractWords("AbeRRaTion tEXt").ToList();
        ...
        {
            var result = WordExtractor.ExtractWords("Fruits: banana, lemon, mango. Vegetables - carrot; cabbage; potato. One + one = one.").ToList();
        ...
        public static void RemoveIllegalWords()
        {
            var result = WordExtractor.ExtractWords(
                "Sit down awhile And let us once again assail your ears That are so fortified against our story What we have two nights seen").ToList();
        ...
        {
            var result = WordExtractor.ExtractWords("test tested testing tests");
